...
@property(nonatomic, assign, readonly) NSInteger bps_received;				/**< 当前接收带宽: 20s计算  */
@property(nonatomic, assign, readonly) NSInteger bps_sent;					/**< 当前发送带宽: 20s计算  */
@property(nonatomic, assign, readonly) NSInteger lostpercent;				/**< 当前丢包率: 20s计算  */
