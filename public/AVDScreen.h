...
@property (nonatomic,retain,readonly) NSMutableArray* publishedScreens; /**< 已共享屏幕窗口信息列表 */

@property (nonatomic,retain,readonly) NSMutableArray* subscribedScreens;/**< 已订阅屏幕窗口信息列表 */
